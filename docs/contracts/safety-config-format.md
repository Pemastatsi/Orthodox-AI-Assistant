...
- Include Greek (`lang: el`) variants matching the corresponding English rule, per the project's Orthodox-Ethos linguistic scope. The founder is responsible for the linguistic correctness of these variants; soliciting informal Greek-reading review before signoff is recommended.
